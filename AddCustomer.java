...
public class AddCustomer extends JFrame implements ActionListener {
    ...
    AddCustomer(){
        ...
        c1=new JComboBox(new String[] {"Passport","Voter-id Card","Driving License","Adhaar Card"});
       ...
       ImageIcon i1=new ImageIcon(ClassLoader.getSystemResource("hotel\\mangement\\system\\icons\\fifth.png"));
       Image i2=i1.getImage().getScaledInstance(300, 400, Image.SCALE_DEFAULT);
       ImageIcon i3=new ImageIcon(i2);
       JLabel l11=new JLabel(i3);
       l11.setBounds(300,-30,500,600);
       add(l11);
        
        getContentPane().setBackground(Color.WHITE);
        setLayout(null);
        setBounds(340,200,750,500);
        setVisible(true);
